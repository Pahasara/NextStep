        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeColor = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ConditionType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ConditionValue = table.Column<int>(type: "INTEGER", nullable: true),
                    ConditionMetadata = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarnedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
